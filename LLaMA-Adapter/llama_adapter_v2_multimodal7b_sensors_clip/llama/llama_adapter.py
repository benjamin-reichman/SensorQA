...
class LLaMA_adapter(nn.Module):
    ...
    def forward_visual(self, sensors, sensors_mask=None):
        ...
        sensor_query = self.visual_query.weight.unsqueeze(
            0).repeat(len(sensors), 1, 1)
    ...
    def forward(self, tokens, labels, sensors, sensors_mask):
    ...
    def generate(
        ...
        with torch.cuda.amp.autocast():
            visual_query = self.forward_visual(imgs, mask)
